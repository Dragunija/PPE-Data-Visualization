...
class ParticleEncoder(json.JSONEncoder):
    def default(self,obj):
        if isinstance(obj,hepmcio.Particle):
            return {"event":obj.evt.num, "_id":obj.barcode, "pid":obj.pid, "mass":obj.mass, "momentum":obj.mom, "start_vertex":obj.nvtx_start, "end_vertex":obj.nvtx_end, "status":obj.status}
        return json.JSONEncoder.default(self,obj)

class VertexEncoder(json.JSONEncoder):
    def default(self,obj):
        if isinstance(obj, hepmcio.Vertex):
            return {"event":obj.evt.num, "_id":obj.barcode, "position":obj.pos}
        return json.JSONEncoder.default(self,obj)

class EventEncoder(json.JSONEncoder):
    def default(self,obj):
        if isinstance(obj, hepmcio.Event):
            return {"_id":obj.num, "weight":obj.weights, "units":obj.units, "xsec":obj.xsec}
        return json.JSONEncoder.default(self,obj)
